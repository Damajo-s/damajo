...
<body>
	...
	<div class="row" id="print">
		<!-- product -->
		<c:forEach var="vo" items="${hddList }">
		<div class="col-md-4 col-xs-6">
			<div class="product">
				...
				<div class="product-body">
					<h3 class="product-name"><a href="hdd_detail.do?no=${vo.hdd_no }&category=${vo.category}">${vo.hdd_name }</a></h3>
	...
	<div class="store-filter clearfix">
		...
		<c:if test="${endPage<hddTotalPage }">
			<li>
