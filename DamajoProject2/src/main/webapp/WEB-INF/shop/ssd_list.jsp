...
<body>
	...
	<div class="row" id="print">
		<!-- product -->
		<c:forEach var="vo" items="${ssdList }">
		<div class="col-md-4 col-xs-6">
			<div class="product">
				...
				<div class="product-body">
					<h3 class="product-name"><a href="ssd_detail.do?no=${vo.ssd_no }&category=${vo.category}">${vo.ssd_name }</a></h3>
	...
	<div class="store-filter clearfix">
		...
		<c:if test="${endPage<ssdTotalPage }">
			<li>
