...
public interface MemberMapper {
	...
	@Select("SELECT no,id,type,num FROM (SELECT no,id,type,rownum as num FROM member ORDER BY num) WHERE num BETWEEN #{start} AND #{end}")
	public List<MemberVO> getUserList(Map map);
