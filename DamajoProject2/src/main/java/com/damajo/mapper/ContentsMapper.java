...
public interface ContentsMapper {
	@Select("Select cpu_no, poster, cpu_name, price, num "
			+ "From (Select cpu_no, poster, cpu_name, price, rownum as num "
			+ "From (Select cpu_no, poster, cpu_name, price "
	...
	@Select("Select ram_no, poster, ram_name, price, num "
			+ "From (Select ram_no, poster, ram_name, price, rownum as num "
			+ "From (Select ram_no, poster, ram_name, price "
	...
	@Select("Select main_no, poster, main_name, price, num "
			+ "From (Select main_no, poster, main_name, price, rownum as num "
			+ "From (Select main_no, poster, main_name, price "
	...
	@Select("Select vga_no, poster, vga_name, price, num "
			+ "From (Select vga_no, poster, vga_name, price, rownum as num "
			+ "From (Select vga_no, poster, vga_name, price "
	...
	@Select("Select ssd_no, poster, ssd_name, price, num "
			+ "From (Select ssd_no, poster, ssd_name, price, rownum as num "
			+ "From (Select ssd_no, poster, ssd_name, price "
	...
	@Select("Select hdd_no, poster, hdd_name, price, num "
			+ "From (Select hdd_no, poster, hdd_name, price, rownum as num "
			+ "From (Select hdd_no, poster, hdd_name, price "
	...
	@Select("Select power_no, poster, power_name, price, num "
			+ "From (Select power_no, poster, power_name, price, rownum as num "
			+ "From (Select power_no, poster, power_name, price "
